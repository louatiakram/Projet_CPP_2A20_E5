...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CONSOMMATIONS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CONSOMMATIONS" 
   (	"ID_ANIMAL" NUMBER, 
	"ID_PRODUIT" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."GESTION_ANIMAUX" 
   (	"ID_ANIMAL" NUMBER, 
	...
	"AGE" NUMBER, 
	"DATE_ENTREE" VARCHAR2(30 BYTE), 
	"EMPLACEMENT" VARCHAR2(30 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table GESTION_PERSO_ANIMAUX
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" 
   (	"CIN" NUMBER, 
	"ID_ANIMAL" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table GESTION_PERSO_VISITEURS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" 
   (	"CIN" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PARTICIPATIONS" 
   (	"NUMERO_VISITEUR" NUMBER, 
	"REFERENCE" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table REGARDS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."REGARDS" 
   (	"ID_ANIMAL" NUMBER, 
	"NUMERO_VISITEUR" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CONSOMMATIONS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ETUDIANTS
SET DEFINE OFF;
...
Insert into SYSTEM.GESTION_ANIMAUX (ID_ANIMAL,NOM,RACE,AGE,DATE_ENTREE,EMPLACEMENT) values ('0',null,null,'0',null,null);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.GESTION_PERSO_ANIMAUX
SET DEFINE OFF;
REM INSERTING into SYSTEM.GESTION_PERSONNEL
SET DEFINE OFF;
REM INSERTING into SYSTEM.GESTION_PERSO_VISITEURS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PARTICIPATIONS
SET DEFINE OFF;
REM INSERTING into SYSTEM.REGARDS
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index GESTION_PERSO_ANIMAUX_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_PERSO_ANIMAUX_PK" ON "SYSTEM"."GESTION_PERSO_ANIMAUX" ("CIN", "ID_ANIMAL") 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_ETUD
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_ETUD" ON "SYSTEM"."ETUDIANTS" ("ID_ETUDIANT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index GESTION_VISITEUR_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_VISITEUR_PK" ON "SYSTEM"."GESTION_VISITEUR" ("NUMERO_VISITEUR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index REGARDS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."REGARDS_PK" ON "SYSTEM"."REGARDS" ("ID_ANIMAL", "NUMERO_VISITEUR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PARTICIPATIONS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PARTICIPATIONS_PK" ON "SYSTEM"."PARTICIPATIONS" ("NUMERO_VISITEUR", "REFERENCE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index GESTION_EVENNEMENT_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_EVENNEMENT_PK" ON "SYSTEM"."GESTION_EVENNEMENT" ("REFERENCE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index GESTION_ANIMAUX_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_ANIMAUX_PK" ON "SYSTEM"."GESTION_ANIMAUX" ("ID_ANIMAL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index GESTION_PRODUIT_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_PRODUIT_PK" ON "SYSTEM"."GESTION_PRODUIT" ("ID_PRODUIT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index GESTION_PERSO_VISITEURS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_PERSO_VISITEURS_PK" ON "SYSTEM"."GESTION_PERSO_VISITEURS" ("CIN", "NUMERO_VISITEUR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index GESTION_PERSONNEL_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."GESTION_PERSONNEL_PK" ON "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index CONSOMMATIONS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."CONSOMMATIONS_PK" ON "SYSTEM"."CONSOMMATIONS" ("ID_ANIMAL", "ID_PRODUIT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
--  Constraints for Table GESTION_PERSO_VISITEURS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" ADD CONSTRAINT "GESTION_PERSO_VISITEURS_PK" PRIMARY KEY ("CIN", "NUMERO_VISITEUR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" MODIFY ("NUMERO_VISITEUR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" MODIFY ("CIN" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."GESTION_ANIMAUX" ADD CONSTRAINT "GESTION_ANIMAUX_PK" PRIMARY KEY ("ID_ANIMAL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_ANIMAUX" MODIFY ("ID_ANIMAL" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REGARDS" ADD CONSTRAINT "REGARDS_PK" PRIMARY KEY ("ID_ANIMAL", "NUMERO_VISITEUR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."REGARDS" MODIFY ("NUMERO_VISITEUR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."REGARDS" MODIFY ("ID_ANIMAL" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CONSOMMATIONS" ADD CONSTRAINT "CONSOMMATIONS_PK" PRIMARY KEY ("ID_ANIMAL", "ID_PRODUIT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CONSOMMATIONS" MODIFY ("ID_PRODUIT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONSOMMATIONS" MODIFY ("ID_ANIMAL" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GESTION_VISITEUR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_VISITEUR" ADD CONSTRAINT "GESTION_VISITEUR_PK" PRIMARY KEY ("NUMERO_VISITEUR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_VISITEUR" MODIFY ("NUMERO_VISITEUR" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ETUDIANTS" ADD CONSTRAINT "PK_ETUD" PRIMARY KEY ("ID_ETUDIANT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PARTICIPATIONS" ADD CONSTRAINT "PARTICIPATIONS_PK" PRIMARY KEY ("NUMERO_VISITEUR", "REFERENCE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PARTICIPATIONS" MODIFY ("REFERENCE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PARTICIPATIONS" MODIFY ("NUMERO_VISITEUR" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GESTION_EVENNEMENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_EVENNEMENT" ADD CONSTRAINT "GESTION_EVENNEMENT_PK" PRIMARY KEY ("REFERENCE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_EVENNEMENT" MODIFY ("REFERENCE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GESTION_PRODUIT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PRODUIT" ADD CONSTRAINT "GESTION_PRODUIT_PK" PRIMARY KEY ("ID_PRODUIT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PRODUIT" MODIFY ("ID_PRODUIT" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GESTION_PERSO_ANIMAUX
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" ADD CONSTRAINT "GESTION_PERSO_ANIMAUX_PK" PRIMARY KEY ("CIN", "ID_ANIMAL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" MODIFY ("ID_ANIMAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" MODIFY ("CIN" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table GESTION_PERSONNEL
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSONNEL" ADD CONSTRAINT "GESTION_PERSONNEL_PK" PRIMARY KEY ("CIN", "CIN_DIRIGEUR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PERSONNEL" MODIFY ("CIN_DIRIGEUR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."GESTION_PERSONNEL" MODIFY ("CIN" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table CONSOMMATIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONSOMMATIONS" ADD CONSTRAINT "CONSOMMATIONS_FK1" FOREIGN KEY ("ID_ANIMAL")
	  REFERENCES "SYSTEM"."GESTION_ANIMAUX" ("ID_ANIMAL") ENABLE;
  ALTER TABLE "SYSTEM"."CONSOMMATIONS" ADD CONSTRAINT "CONSOMMATIONS_FK2" FOREIGN KEY ("ID_PRODUIT")
	  REFERENCES "SYSTEM"."GESTION_PRODUIT" ("ID_PRODUIT") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table GESTION_EVENNEMENT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_EVENNEMENT" ADD CONSTRAINT "GESTION_EVENNEMENT_FK1" FOREIGN KEY ("CIN", "REFERENCE")
	  REFERENCES "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GESTION_PERSO_ANIMAUX
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" ADD CONSTRAINT "GESTION_PERSO_ANIMAUX_FK1" FOREIGN KEY ("CIN", "ID_ANIMAL")
	  REFERENCES "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PERSO_ANIMAUX" ADD CONSTRAINT "GESTION_PERSO_ANIMAUX_FK2" FOREIGN KEY ("ID_ANIMAL")
	  REFERENCES "SYSTEM"."GESTION_ANIMAUX" ("ID_ANIMAL") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GESTION_PERSONNEL
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSONNEL" ADD CONSTRAINT "GESTION_PERSONNEL_FK1" FOREIGN KEY ("CIN", "CIN_DIRIGEUR")
	  REFERENCES "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GESTION_PERSO_VISITEURS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" ADD CONSTRAINT "GESTION_PERSO_VISITEURS_FK1" FOREIGN KEY ("CIN", "NUMERO_VISITEUR")
	  REFERENCES "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") ENABLE;
  ALTER TABLE "SYSTEM"."GESTION_PERSO_VISITEURS" ADD CONSTRAINT "GESTION_PERSO_VISITEURS_FK2" FOREIGN KEY ("NUMERO_VISITEUR")
	  REFERENCES "SYSTEM"."GESTION_VISITEUR" ("NUMERO_VISITEUR") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table GESTION_PRODUIT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."GESTION_PRODUIT" ADD CONSTRAINT "GESTION_PRODUIT_FK1" FOREIGN KEY ("CIN", "ID_PRODUIT")
	  REFERENCES "SYSTEM"."GESTION_PERSONNEL" ("CIN", "CIN_DIRIGEUR") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PARTICIPATIONS" ADD CONSTRAINT "PARTICIPATIONS_FK1" FOREIGN KEY ("NUMERO_VISITEUR")
	  REFERENCES "SYSTEM"."GESTION_VISITEUR" ("NUMERO_VISITEUR") ENABLE;
  ALTER TABLE "SYSTEM"."PARTICIPATIONS" ADD CONSTRAINT "PARTICIPATIONS_FK2" FOREIGN KEY ("REFERENCE")
	  REFERENCES "SYSTEM"."GESTION_EVENNEMENT" ("REFERENCE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table REGARDS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."REGARDS" ADD CONSTRAINT "REGARDS_FK1" FOREIGN KEY ("ID_ANIMAL")
	  REFERENCES "SYSTEM"."GESTION_ANIMAUX" ("ID_ANIMAL") ENABLE;
  ALTER TABLE "SYSTEM"."REGARDS" ADD CONSTRAINT "REGARDS_FK2" FOREIGN KEY ("ID_ANIMAL")
	  REFERENCES "SYSTEM"."GESTION_PRODUIT" ("ID_PRODUIT") ENABLE;
--------------------------------------------------------
