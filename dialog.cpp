...
{
    ui->setupUi(this);
    QPixmap pix("C:/Users/wassim/Desktop/khedma integreeeV1/Projet_CPP_2A20_E5-GestionDesProduits/AA.jpg");
...
void Dialog::on_ImportPDF_clicked()
{
         ...
         ///////////////////////////////
             ...
             QPdfWriter pdf("C:/Users/wassim/Desktop/gestion produits/Liste.pdf");
             ...
             painter.drawPixmap(QRect(100,400,2000,2000),QPixmap("C:/Users/wassim/Desktop/aziz/logo.jpg"));
...
void Dialog::on_table_id_currentIndexChanged(int index)
{
