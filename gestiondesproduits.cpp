...
{
    ui->setupUi(this);
    QPixmap pix("C:/Users/ASUS/Desktop/Smart Parc/FF.jpg");
...
void GestionDesProduits::on_PDF_clicked()
{
        QSqlDatabase db;
                    ...
                    QSqlQuery qry;
                     ...
                     const QString strTitle ="ListeDesProduits";
                     ...
                     QTextDocument *ListeDesProduits = new QTextDocument();
                     ListeDesProduits->setHtml(strStream);
                     ...
                     if (dialog->exec() == QDialog::Accepted)
                     {
                         ...
                         ListeDesProduits->print(&printer);
                     }
...
void GestionDesProduits::on_lineEdit_09_textChanged(const QString &arg1)
{
    ui->tableView->setModel(G.chercher(arg1));
}
